...
目前的NLP研究热点大部分基于更先进的LLM （2022-）。尤其是ChatGPT通过Alignment技术利用少于预训练几千倍的计算和（$50w, 20k小时，相比于GPT-3的$12M）释放了GPT大模型对话能力并火出圈。所以本库对这些文章进行追踪和归类，更能让我们把握前沿，看清方向。个人想法，不妥之处或者建议请指正。
