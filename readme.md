...
目前的NLP研究热点大部分基于更先进的LLM （2022-）。尤其是ChatGPT通过[Alignment](https://www.cs.princeton.edu/courses/archive/fall22/cos597G/lectures/lec22.pdf)技术利用少于预训练几千倍的计算和（500k美元, 20k小时，相比于GPT-3的12000k美元
